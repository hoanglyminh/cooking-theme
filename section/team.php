        ...
        <div class="row cards justify-content-center">
            <div class="col-lg-4 col-md-6 mt-5">
                <a href="#img" class="card">
                    <img src="<?php bloginfo( 'template_url' ) ?>/assets/images/team1.jpg" class="card__image radius-image" alt="" />
            ...
            <div class="col-lg-4 col-md-6 mt-5">
                <a href="#img" class="card">
                    <img src="<?php bloginfo( 'template_url' ) ?>/assets/images/team2.jpg" class="card__image radius-image" alt="" />
                    <div class="card__overlay">
                        <div class="card__header">
                            <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                                <path />
            ...
            <div class="col-lg-4 col-md-6 mt-5">
                <a href="#img" class="card">
                    <img src="<?php bloginfo( 'template_url' ) ?>/assets/images/team3.jpg" class="card__image radius-image" alt="" />
                    <div class="card__overlay">
                        <div class="card__header">
                            <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                                <path />
